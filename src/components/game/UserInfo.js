...
const NameEditor = ({ inputText, handleNameChange, handleSubmit }) => {
  return (
...
const NameDisplay = ({ playerName, setNameEdit }) => {
  return (
    <div onClick={() => setNameEdit(true)}>Player name: <span className='hover:animate-pulse'>{playerName}</span></div>
  )
}
